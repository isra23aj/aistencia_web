...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(58, 10, utf8_decode('EMPLEADO'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('DNI'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('CARGO'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('ENTRADA AM'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('SALIDA AM'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('ENTRADA PM'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('SALIDA PM'), 1, 1, 'C', 1);
   }
...
$contulta_reporte_asistencia = $conexion->query(" SELECT
asistencia.entrada,
asistencia.salida,
...
while ($datos_reporte = $contulta_reporte_asistencia->fetch_object()) {      
   $i = $i + 1;
   /* TABLA */
   $pdf->Cell(15, 10, utf8_decode("$i"), 1, 0, 'C', 0);
   $pdf->Cell(58, 10, utf8_decode($datos_reporte->nombre ." ".$datos_reporte->apellido ), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode("$datos_reporte->dni"), 1, 0, 'C', 0);
   $pdf->Cell(25, 10, utf8_decode("$datos_reporte->nom_cargo"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->entrada"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->salida"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->entrada_pm"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->salida_pm"), 1, 1, 'C', 0);
}
