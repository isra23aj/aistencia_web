...
<div class="page-content">
  ...
  <div class="row">
    ...
    <?php
      ...
      <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
        <input type="text" placeholder="Teléfono" class="input input__text" name="txttelefono" value="<?= $datos->telefono ?>">
      </div>
      <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
        <input type="text" placeholder="Ubicación" class="input input__text" name="txtubicacion" value="<?= $datos->ubicacion ?>">
      </div>
      <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
