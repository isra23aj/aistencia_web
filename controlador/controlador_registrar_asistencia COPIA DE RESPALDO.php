                                        ...
                                        <script>
                                            $(function notificacion() {
                                                new PNotify({
                                                    ...
                                                    text: "Bienvenido, Marco en Asis Continuo",
                                                    styling: "bootstrap3"
                                                })
                                            })
                                        </script>
                                    ...
                                    <script>
                                        $(function notificacion() {
                                            new PNotify({
                                                title: "Error",
                                                type: "error",
                                                text: "Ya Registró su Entrada o aún no puede marcar salida, Continuo.",
                                                styling: "bootstrap3"
                                            })
                                        })
                                    </script>
                                        ...
                                        <script>
                                            $(function notificacion() {
                                                new PNotify({
                                                    ...
                                                    text: "Bienvenido, MARCÓ FUERA DE HORARIO, Continuo",
                                                    styling: "bootstrap3"
                                                })
                                            })
                                        </script>
                            ...
                            <script>
                                $(function notificacion() {
                                    new PNotify({
                                        title: "Error",
                                        type: "error",
                                        text: "El sistema no se encuentra habilitado,Continuo.",
                                        styling: "bootstrap3"
                                    })
                                })
                            </script>
                                    ...
                                    <script>
                                        $(function notificacion() {
                                            new PNotify({
                                                ...
                                                type: "alert",
                                                //text: "Bienvenido al turno de la MAÑANA < ?="HoraTOL:".$horaTol." Tolerancia:".$tolerancia." Hora am:".$seg_hora." Entrada:".$entrada?>",
                                                text: "Bienvenido, Marco Fuera de Hora",
                                                styling: "bootstrap3"
                                            })
                                        })
                                    </script>
                                    ...
                                    <script>
                                        $(function notificacion() {
                                            new PNotify({
                                                ...
                                                text: "Error al registrar su entrada TARDE",
                                                styling: "bootstrap3"
                                            })
                                        })
                                    </script>
                                    ...
                                    <script>
                                        $(function notificacion() {
                                            new PNotify({
                                                title: "Incorrecto",
                                                type: "error",
                                                text: "Error al registrar su entrada2",
                                                styling: "bootstrap3"
                                            })
                                        })
                                        </script>
                            ...
                            <script>
                                $(function notificacion() {
                                    new PNotify({
                                        title: "Incorrecto",
                                        type: "error",
                                        text: "Primero debe registrar su entrada, continuo",
                                        styling: "bootstrap3"
                                    })
                                })
                            </script>
                            ...
                            <script>
                                $(function notificacion() {
                                    new PNotify({
                                        title: "Incorrecto",
                                        type: "error",
                                        text: "Ya se registro su salida de la mañana, continuo",
                                        styling: "bootstrap3"
                                    })
                                })
                            </script>
                            ...
                            <script>
                                $(function notificacion() {
                                    new PNotify({
                                        title: "Incorrecto",
                                        type: "error",
                                        text: "No puede marcar su salida, continuo..",
                                        styling: "bootstrap3"
                                    })
                                })
                            </script>
                                ...
                                <script>
                                    $(function notificacion() {
                                        new PNotify({
                                            title: "Incorrecto",
                                            type: "error",
                                            text: "Ya se registro su salida, continuo",
                                            styling: "bootstrap3"
                                        })
                                    })
                                </script>
                ...
                if (substr($fecha, 0, 10) != substr($entradaBDPM, 0, 10)) { ?>
                    ...
                    <?php
                                        ...
                                        if ($marcarS>=$horaSalida and $marcarS <= $limPM ) {
                                            ...
                                            //insertarsql
                                            //$sqlActPM = $conexion->query(" update asistencia set salida_pm ='$fecha' where id_empleado=$id_empleado and entrada='$fechaBD' ");
                                            //$sql = $conexion->query(" select * from empleado");
                                        if ($sql == true) { ?>
                    <script>
                        $(function notificacion() {
                    ...
                    <script>
                        $(function notificacion() {
                            new PNotify({
                                title: "Incorrecto",
                                type: "error",
                                text: "No puede marcar salida PM",
                                styling: "bootstrap3"
                            })
                        })
                    </script>
                            ...
                            <script>
                                $(function notificacion() {
                                    new PNotify({
                                        title: "Incorrecto",
                                        type: "error",
                                        text: "No puede marcar salida AM",
                                        styling: "bootstrap3"
                                    })
                                })
                            </script>
